        ...
        <>
            <header className="bg-blue-900 body-font">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    {/* <button className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 m-1 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0"><Link to={"/auth/SignUp"}>Sign Up</Link>
                    </button> */}
                </div>
            </header>
        </>
